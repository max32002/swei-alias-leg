...
獅尾鋸腿黑體基於[思源黑體](https://github.com/adobe-fonts/source-han-sans)的轉角挖空改造，更加簡明現代化的字體。支援简体中文、繁體中文、韓文與日文；可以免費商用，歡迎大家自由應用、自由優化、自由改作！
...
![字體預覽](https://github.com/max32002/swei-alias-leg/raw/master/preview/welcome.png)

和思源黑體一樣，支援7種的字重：
![字體比較預覽](https://github.com/max32002/swei-alias-leg/raw/master/preview/compare_style.png)
...
### 「CJK TC」和「CJK SC」的比較：
![TC和SC比較](https://github.com/max32002/swei-alias-leg/raw/master/preview/compare_tc_sc.png)
...
### 「CJK TC」和「CJK JP」的比較：
![TC和SC比較](https://github.com/max32002/swei-alias-leg/raw/master/preview/compare_tc_jp.png)
...
## 更新日誌
[點擊此處](https://github.com/max32002/swei-alias-leg/blob/master/change_log.md) 查看更新記錄。
...
```
@font-face {
  font-family: SweiAliasLegCJKtc-Regular;
  src: url(https://cdn.jsdelivr.net/gh/max32002/swei-alias-leg@2.0/WebFont/CJK%20TC/SweiAliasLegCJKtc-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/swei-alias-leg@2.0/WebFont/CJK%20TC/SweiAliasLegCJKtc-Regular.woff) format("woff");
}
```
...
* 演算黑科技將字體的轉角挖空改造，請參考「獅尾鋸齒黑體」 /python/ 目錄下的腳本檔案。透過調整程式碼，也許也可以產生出新的有趣字型。目前的程式應該還有很多錯誤或需要再加強的地方。請先把要處理的字型，透過 FontForge 開啟，並另存 FontForge 的專案為資料夾格式(.sfdir)，最後就可以透過Max的 Python 程式去處理產生出來的檔案。
